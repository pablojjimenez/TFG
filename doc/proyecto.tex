...
{
    name=SNS,
    description={El Sistema Nacional de Salud de España es el ente que engloba a las prestaciones y servicios sanitarios de España.}
}
\makenoidxglossaries
...
\begin{document}
	...
	\input{doc/prefacios/prefacio.tex}
	...
	\input{doc/secciones/05_analisis.tex}
