...
\begin{figure}[h]
    ...
    \caption{Coste del cambio en un proyecto con arquitectura desacoplada en comparación con una acoplada. \href{https://www.cosmicpython.com/book/images/apwp_0205.png}{Fuente de la imagen.}}
...
GraphQL es un protocolo agnóstico del lenguaje de programación, del sistema de
