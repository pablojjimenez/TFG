...
En el \hyperref[sec:ejemplos]{anexo} de este trabajo se puede apreciar ejemplos de llamadas.
...
\begin{figure}[h]
	\centering	
	\includegraphics[width=\textwidth]{doc/logos/imgs/mutaciones-explorer.png}
