...
En este apartado lo que pretende es mostrar como se encuentra el panorama en el cual vamos
...
\begin{figure}[]
    ...
    \label{fig:worst_f_value}
\end{figure}
\FloatBarrier Los datos son ofrecidos mediante un mapa de España interactivo podemos
observar también gráficas de todas las provincias y la media nacional así como una tabla
con los datos. Es de obligado comentar la antigüedad manifiesta de la página y la poca
...
Es un servidor interactivo \footnote{http://raziel.cne.isciii.es/index.php} que genera
...
Estas variables son las disponibles desde la interfaz web. Además, la web es prácticamente
