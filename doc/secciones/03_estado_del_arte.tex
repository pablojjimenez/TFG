...
En este \hyperref{enlace}{https://www.ine.es/jaxiT3/Tabla.htm?t=6609} se pueden observar las defunciones según causa de muerte filtradas por causa, sexo, edad y periodo. 
...
\begin{figure}[]
	...
	\caption{ Vista principal del \hyperref{servidor Arïadna}{http://ariadna.cne.isciii.es/} }
    \label{fig:worst_f_value}
\end{figure}
