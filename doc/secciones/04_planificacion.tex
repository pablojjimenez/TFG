...
lograr la interacción del equipo de desarrollo con el usuario. Ello se consigue por medio de historias de usuaior. Las HUs tienen que cumplir una serie de condiciones \cite{dddjj}:
\begin{itemize}
