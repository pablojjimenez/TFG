...
\begin{table}[H]
	...
	\begin{tabular}{@{}ccc@{}}
	    ...
	    \textbf{4. Interfaz REST} & 17 de mayo & 5 de junio \\
	    \textbf{5. Interfaz GraphQL} & 6 de junio & 26 de junio \\
...
\begin{table}[H]
	...
	\begin{tabular}{@{}ccc@{}}
		\toprule
		\rowcolor[HTML]{ECF4FF} 
		\textbf{Concepto} & \teextbf{Coste} & \textbf{Comentarios} \\ \midrule
	...
	\end{tabular}}
	\caption{Coste de los recursos empleados en el proyecto.}
\end{table}
